...
export class PageGmapAutocomplete {
    ...
    constructor(
        ...
        this.regionals = [{
            "title": "Marker 1",
            "latitude": this.currLoc.Lat,
            "longitude": this.currLoc.Long
        }];
    }
    ...
    initializeMap() {
        this.zone.run(() => {
            ...
            this.map = new google.maps.Map(mapEle, {
                zoom: 10,
                center: { lat: this.currLoc.Lat, lng: this.currLoc.Long },
    ...
    getCurrentPositionfromStorage(markers) {
        let myPos = new google.maps.LatLng(this.currLoc.Lat, this.currLoc.Long);
        this.map.setOptions({
            center: myPos,
            zoom: 14
        });
        let marker = this.addMarker(myPos, "");
